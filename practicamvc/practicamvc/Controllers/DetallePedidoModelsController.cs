...
namespace practicamvc.Controllers
{
    public class DetallePedidoModelsController : Controller
    {
        ...
        {
            ViewData["PedidoId"] = new SelectList(_context.Set<PedidoModel>(), "Id", "Estado");
            ViewData["ProductoId"] = new SelectList(_context.Set<ProductoModel>(), "Id", "Nombre");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,PedidoId,ProductoId,Cantidad,PrecioUnitario")] DetallePedidoModel detallePedidoModel)
        {
            ...
            ViewData["PedidoId"] = new SelectList(_context.Set<PedidoModel>(), "Id", "Estado", detallePedidoModel.PedidoId);
            ViewData["ProductoId"] = new SelectList(_context.Set<ProductoModel>(), "Id", "Nombre", detallePedidoModel.ProductoId);
            return View(detallePedidoModel);
        }
